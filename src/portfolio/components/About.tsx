      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            {/* Avatar placeholder */}
            <div className="w-32 h-32 rounded-2xl bg-brand-surface border border-brand-border flex items-center justify-center">
              <span className="text-3xl font-bold text-brand-violet select-none">NM</span>
            </div>
            ...
            <div className="flex flex-col gap-2 p-4 rounded-xl bg-brand-surface border border-brand-border">
              ...
              <p className="text-brand-text text-sm font-medium">Contract · Consulting · Advisory Roles</p>
              <p className="text-brand-muted text-xs">Malaysia · APAC · Global Remote</p>
            </div>
            ...
            <div className="flex flex-col gap-3 p-4 rounded-xl bg-brand-surface border border-brand-border">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-brand-muted">Kuala Lumpur, Malaysia</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
          ...
          <div className="lg:col-span-3 flex flex-col gap-6">
            ...
            <p className="text-brand-muted text-base sm:text-lg leading-relaxed">
              ...
              Telecom (M1 Digital Labs / Keppel), Energy (Petronas ICT), and BFSI (Standard Chartered Bank, AIG). My
              focus has always been the same: build delivery rigour that scales, reduce the noise that slows teams down,
              and ship outcomes that hold up under audit. Available as a contract IT project manager Malaysia-wide and
              globally remote.
            </p>
