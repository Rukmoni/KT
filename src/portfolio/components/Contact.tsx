...
const CONTACT_ITEMS = [
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/nagarajanmaheswaran',
        ...
        <div className="w-full max-w-2xl bg-brand-bg border border-brand-border rounded-2xl p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-brand-muted mt-3 text-sm sm:text-base leading-relaxed">
              Open to contract, consulting, and advisory opportunities across APAC and global remote.
              Senior PM telecom banking energy Malaysia — let's discuss your programme needs.
            </p>
          </div>

          <div className="flex flex-col gap-3 mb-8">
            {CONTACT_ITEMS.map((item) => (
              <div key={item.label} className="flex items-center gap-4 p-4 rounded-xl bg-brand-surface border border-brand-border hover:border-brand-violet/40 transition-colors duration-200">
