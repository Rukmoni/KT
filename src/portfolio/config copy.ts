...
//
// HOW TO USE:
//   import { PERSON, SITE, METRICS, EXPERIENCE, CERTS, SERVICES }
//   from '@/config'
//
// Update this file whenever anything changes — every component
// reads from here, so you only ever edit one place.
// ─────────────────────────────────────────────────────────────
...
export const PERSON = {
  ...
  // Assets — swap these when ready
  headshot: "/nagarajan.jpg", // 400×400 minimum, square crop
  cv: "/nagarajan-cv.pdf",
...
// Mirror these in tailwind.config.ts → theme.extend.colors.brand
...
export const CERTS = [
  {
    ...
    issuerShort: "PMI",
    year: null, // add year if you want it displayed
...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    company: "Tentacle Technologies · Hexacorp · Virtusa (SCB) · Mphasis (AIG)",
    ...
    current: false,
    achievements: [
      "Delivery leadership across banking (Standard Chartered Bank), insurance (AIG), and enterprise software",
      "AIG IntelliRisk platform delivery; COBOL-to-.NET migration covering 150K+ policies; SCB Compliance Portal and GTO Executive Dashboard",
      "Full-stack engineering foundation across security, CRM, payments, and enterprise platforms (2000–2006)",
    ],
  },
] as const;

// ── 7. ADVISORY SERVICES (Kuvanta) ───────────────────────────
