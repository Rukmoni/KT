...
export const HighLights = () => {
  ...
  return (
    <section className="relative w-full py-24 bg-gradient-to-b from-[#0B0F1A] to-[#0A0D14] overflow-hidden text-white min-h-[900px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pb-16 pt-8 relative z-10 flex flex-col items-center">
        <motion.div 
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="uppercase tracking-widest text-[#a8b8d8] text-[0.65rem] font-bold py-1.5 px-4 bg-white/5 border border-white/10 rounded-full inline-block mb-6"
        >
          HIGHLIGHTS
        </motion.div>
        <motion.h2 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-4xl md:text-[3.25rem] leading-tight font-bold text-white mb-6 tracking-tight"
        >
          Product <span className="bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent">Highlights</span>
        </motion.h2>
        <motion.p 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          className="text-[#a1a1aa] max-w-2xl mx-auto text-[0.95rem] md:text-base leading-relaxed"
        >
      ...
      <div className="mt-12 text-center max-w-xl mx-auto px-4 h-28 relative z-10">
        <AnimatePresence mode="wait">
          ...
          >
            <h3 className="text-white font-semibold text-2xl md:text-[1.75rem] mb-3 tracking-tight">{HIGHLIGHTS[activeIndex].title}</h3>
            <p className="text-[#a1a1aa] text-[0.95rem] md:text-base leading-relaxed">{HIGHLIGHTS[activeIndex].desc}</p>
          </motion.div>
        </AnimatePresence>
      </div>
